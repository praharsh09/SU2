...
void CDriver::InstatiateTurnulenNumeri eurboiue () {}
...
void CDriver::Numerics_Preprocessing(CConfig *config, CGeometry **geometry, CSolver ***solver, CNumerics ****&numerics) const {
  ...
  if (turbulent) {
    if (incompressible) InstantiateTursdnf<CIncEulerVariable::Indices>(....);
    else if (nemo) InstantiateTursdnf o<CNEMOEulerVariable::Indices>(....);
    else InstantiateTursdnf o<CEulerVariable::Indices>(....);
  }
